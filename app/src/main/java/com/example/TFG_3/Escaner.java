...
public class Escaner extends Activity {
    ...
    public void incicializarImagen(){
        ...
        arcos.add(a12a11);
        ImageView a11e4 = findViewById(R.id.a11e4);
        arcos.add(a11e4);
        ...
        arcos.add(a103a104);
        ImageView a104v102 = findViewById(R.id.a104v102);
        arcos.add(a104v102);
        ImageView v102a105 = findViewById(R.id.v102a105);
        arcos.add(v102a105);
        ImageView a105a106 = findViewById(R.id.a105a106);
        arcos.add(a105a106);
        ImageView a106a107 = findViewById(R.id.a106a107);
        arcos.add(a106a107);
        ImageView a107b102 = findViewById(R.id.a107b102);
        arcos.add(a107b102);
        ImageView a108b102 = findViewById(R.id.b102a108);
        arcos.add(a108b102);
        ImageView a108a109 = findViewById(R.id.a108a109);
        arcos.add(a108a109);
        ImageView a109v103 = findViewById(R.id.a109v103);
        arcos.add(a109v103);
        ImageView v103a110 = findViewById(R.id.v103a110);
        arcos.add(v103a110);
        ImageView a110a111 = findViewById(R.id.a110a111);
        arcos.add(a110a111);
        ImageView b103a111 = findViewById(R.id.a111b103);
        arcos.add(b103a111);
        ImageView a112b103 = findViewById(R.id.a112b103);
        arcos.add(a112b103);
        ImageView a113a112 = findViewById(R.id.a112a113);
        arcos.add(a113a112);
        ImageView a113p1 = findViewById(R.id.a113p1);
        arcos.add(a113p1);
        ImageView p1a114 = findViewById(R.id.a114p1);
        arcos.add(p1a114);

        ImageView a114a115 = findViewById(R.id.a114a115);
        arcos.add(a114a115);
        ImageView a115b104 = findViewById(R.id.a115b104);
        arcos.add(a115b104);
        ImageView b104a116 = findViewById(R.id.b104a116);
        arcos.add(b104a116);
        ImageView a116a117 = findViewById(R.id.a116a117);
        arcos.add(a116a117);
        ImageView a117v101 = findViewById(R.id.a117v101);
        arcos.add(a117v101);
        ...
        arcos.add(a203a204);
        ImageView a204v202 = findViewById(R.id.a204v202);
        arcos.add(a204v202);
        ImageView v202a205 = findViewById(R.id.v202a205);
        arcos.add(v202a205);
        ImageView a205a206 = findViewById(R.id.a205a206);
        arcos.add(a205a206);
        ImageView a206a207 = findViewById(R.id.a206a207);
        arcos.add(a206a207);
        ImageView a207b202 = findViewById(R.id.a207b202);
        arcos.add(a207b202);
        ImageView b202a208 = findViewById(R.id.b202a208);
        arcos.add(b202a208);
        ImageView a208a209 = findViewById(R.id.a208a209);
        arcos.add(a208a209);
        ImageView a209v203 = findViewById(R.id.a209v203);
        arcos.add(a209v203);
        ImageView v203a210 = findViewById(R.id.v203a210);
        arcos.add(v203a210);
        ImageView a210a211 = findViewById(R.id.a210a211);
        arcos.add(a210a211);
        ImageView a211b203 = findViewById(R.id.a211b203);
        arcos.add(a211b203);
        ImageView b203a212 = findViewById(R.id.a212b203);
        arcos.add(b203a212);
        ImageView a212a213 = findViewById(R.id.a212a213);
        arcos.add(a212a213);
        ImageView a213p2 = findViewById(R.id.a213p2);
        arcos.add(a213p2);
        ImageView a214p2 = findViewById(R.id.a214p2);
        arcos.add(a214p2);
        ImageView a214a215 = findViewById(R.id.a214a215);
        arcos.add(a214a215);
        ImageView a215b204 = findViewById(R.id.a215b204);
        arcos.add(a215b204);
        ImageView b204a216 = findViewById(R.id.b204a216);
        arcos.add(b204a216);
        ImageView a216a217 = findViewById(R.id.a216a217);
        arcos.add(a216a217);
        ImageView a217v201 = findViewById(R.id.a217v201);
        arcos.add(a217v201);
        ...
        ImageView a213esc207 = findViewById(R.id.a213esc207);
        arcos.add(a213esc207);
        ImageView esc207p2 = findViewById(R.id.esc207p2);
        arcos.add(esc207p2);
        ImageView p2esc208 = findViewById(R.id.esc208p2);
        arcos.add(p2esc208);
        ImageView esc208a214 = findViewById(R.id.esc208a214);
        arcos.add(esc208a214);
    ...
    public void interfazPiso(String nomTransmisor){
        ...
        if (t.getPiso() == 0){
            ...
            layoutp2.setVisibility(View.GONE);
            img.setImageResource(R.drawable.mapaaulario2);
